 ...
 */
public class AsmToolsCorrectnessTest {
    private Log log = LogFactory.getLog(AsmToolsCorrectnessTest.class);
    ...
    public AsmToolsCorrectnessTest() throws MalformedURLException {
    }
    ...
    public void testCorrectnessWithoutFD() throws Exception {
        ...
        taskExecutor.addTask(new RunCommandTask(antBuildSrcDir, new String(Files.readAllBytes(Paths.get(this.getClass().getResource("ant_command.txt").toURI())))));
        ...
        taskExecutor.addTask(new RunCommandTask(plutoBuildSrcDir, plutoRunCommand));

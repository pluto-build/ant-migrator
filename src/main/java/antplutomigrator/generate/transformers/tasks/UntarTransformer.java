...
public class UntarTransformer extends SpecializedTaskTransformer {
    public UntarTransformer(UnknownElement element, ElementGenerator elementGenerator, AntIntrospectionHelper introspectionHelper) {
    ...
    public void transform() throws RuntimeException {
        ...
        generator.printString("FileOperations.untar("+generateToFile(attributeForKey("src"))+", "+generateToFile(attributeForKey("dest"))+");");
    }
}

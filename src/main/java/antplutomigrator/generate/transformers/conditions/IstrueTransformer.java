...
public class IstrueTransformer extends SpecializedConditionTransformer {
    public IstrueTransformer(UnknownElement element, ElementGenerator elementGenerator, AntIntrospectionHelper introspectionHelper) {
